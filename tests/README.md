...
.venv/bin/python tests/test_motion_gate.py         # motion gate: warp chaining, CMC-decisive rule, stage + audit check with negative controls (needs tracklab, no torch)
